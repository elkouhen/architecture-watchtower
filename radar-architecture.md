...
Publie au minimum 5 sujets et normalement 5 à 7, au plus 10 sauf alerte critique. Pour atteindre le minimum, élargis d’abord la qualification aux deltas primaires déjà collectés et aux pistes de découverte pertinentes, sans élargir la fenêtre de 90 jours ni abaisser les trois filtres. S'il manque encore des sujets, complète avec les signaux actifs les plus importants dont la source primaire et le statut ont été revus pendant l'exécution : leur type est `Mise à jour` et leur fiche commence par `Fait — suivi de signal existant`, sans les présenter comme une nouvelle annonce. Ne fabrique jamais un sujet faible : un suivi doit conserver une preuve primaire, un effet architectural et une décision active. Vise 12 à 20 candidats ; si les flux en fournissent moins, examine-les tous et indique le rendement et la part de suivis dans `Sujets écartés`.
