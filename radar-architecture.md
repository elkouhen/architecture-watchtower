...
Publie au minimum 5 sujets et normalement 5 à 7, au plus 10 sauf alerte critique. Pour atteindre le minimum, élargis la qualification aux deltas primaires déjà collectés et aux pistes de découverte pertinentes, sans élargir la fenêtre de 90 jours ni abaisser les trois filtres. Si moins de 5 sujets possèdent effectivement un changement substantiel, un impact architectural et une preuve primaire, publie tous les sujets éligibles et inscris `Exception minimum de sujets : <motif factuel>` dans `Sujets écartés` ; ne fabrique et ne force jamais un sujet faible. Vise 12 à 20 candidats ; si les flux en fournissent moins, examine-les tous et indique le rendement et sa cause dans `Sujets écartés`.
