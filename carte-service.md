...
La carte contribue au maintien de l’expertise de Mehdi, architecte Cloud/DevOps. Elle doit donc rendre explicite ce que le service change dans une architecture moderne, dans quels scénarios il devient pertinent et quel niveau de compétence opérationnelle il permet d’acquérir. Les services HashiCorp font partie du périmètre d’intérêt, notamment Terraform, Vault, Consul, Nomad, Boundary, Packer, Vagrant, Waypoint et HCP. Privilégie les explications qui aident à décider et à agir plutôt qu’une description encyclopédique.
