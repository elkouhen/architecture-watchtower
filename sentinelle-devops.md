...
Avant de produire le rapport, recherche dans Gmail les emails envoyés à mehdi.elkouhen@gmail.com au cours des 90 derniers jours dont l’objet commence par « Alerte DevOps », « Radar Architecture » ou « Revue Architecture ». Extrais leurs URL et sujets déjà signalés. Ne répète un sujet que si son statut, son échéance ou son niveau de risque a changé. Dans ce cas, indique clairement « Mise à jour ».
...
EMAIL
S’il n’existe aucun élément avec un score supérieur ou égal à 6, n’envoie aucun email et indique seulement dans le résultat planifié « Aucun signal prioritaire ».
Sinon, envoie le rapport complet par Gmail à mehdi.elkouhen@gmail.com.
Objet :
- « ALERTE DevOps — AAAA-MM-JJ » si au moins un score est supérieur ou égal à 8 ;
- sinon « Alerte DevOps — AAAA-MM-JJ ».
