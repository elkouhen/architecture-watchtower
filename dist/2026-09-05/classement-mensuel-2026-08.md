...
| Rang | Technologie | Pitch rapide — pourquoi c’est intéressant | Tendance | Classe | Lien vers la preuve |
|---:|---|---|---|---|---|
| 1 | [Model Context Protocol 2026-07-28](https://modelcontextprotocol.io/specification/2026-07-28) | Nouveau contrat stateless et routable pour relier agents, outils, gateways et autorisation. | forte | priorité nouveauté | [carte](../2026-08-29/carte-mcp.md) |
| 2 | [Kubernetes 1.37](https://kubernetes.io/releases/1.37/) | Évolution de socle qui combine version de plateforme, migration de stockage et nouvelles API. | forte | priorité nouveauté | [radar](../2026-08-27/radar-architecture.md#kubernetes-137) |
| 3 | [Agent Sandbox](https://github.com/kubernetes-sigs/agent-sandbox) | CRD qui transforme l’isolation persistante des agents en capacité de plateforme Kubernetes. | émergente | priorité nouveauté | [carte](../2026-08-28/carte-agent-sandbox.md) |
| 4 | [OpenTelemetry Collector 0.159](https://github.com/open-telemetry/opentelemetry-collector-releases) | Rend l’observabilité versionnée comme un composant de plateforme avec cadence et stabilité explicites. | forte | priorité nouveauté | [radar](../2026-08-30/radar-architecture.md#opentelemetry-collector-0159) |
| 5 | [Cloud Native Buildpacks](https://buildpacks.io/) | Standardise le chemin source-vers-OCI et relie build, SBOM et supply chain. | émergente | priorité nouveauté | [radar](../2026-08-30/radar-architecture.md#cloud-native-buildpacks-graduation) |
| 6 | [Kubeflow](https://www.kubeflow.org/) | Graduation CNCF qui consolide le cycle de vie Data & AI sur Kubernetes. | émergente | priorité nouveauté | [radar](../2026-08-30/radar-architecture.md#kubeflow-graduation-cncf) |
| 7 | [AI Gateway](https://kubernetes.io/blog/2026/03/09/announcing-ai-gateway-wg/) | Fait émerger une couche de gouvernance dédiée au trafic vers les modèles. | forte | priorité nouveauté | [radar](../2026-08-27/radar-architecture.md#ai-gateway) |
| 8 | [agentgateway 1.4](https://github.com/agentgateway/agentgateway/releases) | Combine routage IA, MCP, OAuth et contrôles LLM dans une gateway spécialisée. | émergente | à qualifier | [radar](../2026-08-29/radar-architecture.md#agentgateway-14) |
| 9 | [kgateway 2.4](https://github.com/kgateway-dev/kgateway) | Étend Gateway API vers policies, backends AWS et routage de zone. | émergente | à qualifier | [radar](../2026-08-30/radar-architecture.md#kgateway-24) |
| 10 | [AgentOps et observabilité IA](https://github.com/topics/agent-observability) | Déplace l’observabilité des agents vers traces, coûts, évaluations et actions. | forte | à qualifier | [radar](../2026-08-27/radar-architecture.md#agentops-et-observabilité-ia) |
| 11 | [OpenTelemetry GenAI](https://opentelemetry.io/blog/2026/genai-observability/) | Propose un langage commun pour observer tokens, modèles, outils et traces d’agents. | forte | à qualifier | [radar](../2026-08-27/radar-architecture.md#opentelemetry-genai) |
| 12 | [GitHub MCP allowlists](https://github.blog/changelog/2026-08-06-mcp-allowlists-in-enterprise-managed-settings/) | Transforme l’autorisation des serveurs MCP en politique d’entreprise centralisée. | émergente | à qualifier | [radar](../2026-08-29/radar-architecture.md#gouvernance-mcp-github) |
| 13 | [Limites de cardinalité OpenTelemetry](https://opentelemetry.io/blog/2026/cardinality-limits-in-opentelemetry/) | Rend visible le compromis entre richesse des dimensions et coût/mémoire des métriques. | émergente | à qualifier | [radar](../2026-08-29/radar-architecture.md#limites-de-cardinalité-opentelemetry) |
| 14 | [Nomad 1.10](https://developer.hashicorp.com/nomad/docs/release-notes/v1-10-x) | Renforce l’identité de workload comme contrat entre orchestrateur, Vault et Consul. | émergente | à qualifier | [radar](../2026-08-29/radar-architecture.md#nomad-110--identité-de-workload) |
| 15 | [Terraform 1.17 alpha](https://github.com/hashicorp/terraform) | Fait évoluer les tests et requêtes IaC vers une validation plus programmable. | émergente | veille | [radar](../2026-08-29/radar-architecture.md#terraform-117-alpha) |
| 16 | [Agent Plugins 1.0](https://github.blog/changelog/2026-08-12-agent-plugins-1-0-in-vs-code-copilot-cli-and-the-copilot-app/) | Donne un format commun pour distribuer skills et serveurs MCP à plusieurs clients. | émergente | veille | [radar](../2026-08-29/radar-architecture.md#agent-plugins-10) |
| 17 | [Amazon ECS Action Logs](https://aws.amazon.com/about-aws/whats-new/2026/07/amazon-ecs-action-logs/) | Améliore la reconstruction des changements opérateur dans les déploiements ECS. | stable | veille | [radar](../2026-08-29/radar-architecture.md#amazon-ecs-action-logs) |
| 18 | [Elasticsearch 9.5.2](https://www.elastic.co/elasticsearch) | Carte de référence pour comprendre le moteur, ses flux, son déploiement et son lifecycle. | stable | à qualifier | [carte](../2026-08-27/carte-elasticsearch.md) |
| 19 | [OpenAgentPack](https://github.com/modelstudioai/OpenAgentPack) | Explore un control plane déclaratif pour déployer et gouverner des agents cloud. | faible | veille | [radar](../2026-08-28/radar-architecture.md#openagentpack) |
| 20 | [Busbar](https://github.com/GetBusbar/busbar) | Réunit routage, budgets et failover dans une frontière d’exécution IA. | faible | veille | [radar](../2026-08-28/radar-architecture.md#busbar) |
| 21 | [OpenConnector](https://github.com/oomol-lab/open-connector) | Traite les connecteurs SaaS comme des capacités gouvernées via MCP, HTTP et OpenAPI. | émergente | veille | [radar](../2026-08-28/radar-architecture.md#openconnector) |
| 22 | [PRAXIST](https://github.com/sapientinc/PRAXIST) | Introduit une piste de recherche agentique mesurable et persistante. | faible | signal faible | [radar](../2026-08-29/radar-architecture.md#praxist) |
| 23 | [WeMM-Embedding](https://github.com/Tencent/WeMM-Embedding) | Illustre la convergence embeddings multimodaux et retrieval. | faible | signal faible | [radar](../2026-08-28/radar-architecture.md#wemm-embedding) |
| 24 | [go-modern-guidelines](https://github.com/JetBrains/go-modern-guidelines) | Formalise des pratiques Go lisibles par des agents de code. | faible | signal faible | [radar](../2026-08-28/radar-architecture.md#go-modern-guidelines) |
| 25 | [Archify](https://github.com/tt-a1i/archify) | Convertit code ou description en artefacts d’architecture explorables. | faible | signal faible | [radar](../2026-08-28/radar-architecture.md#archify) |
| 26 | [Tailcat](https://github.com/tailscale/tailcat) | Propose un outil de diagnostic réseau adapté au data plane Tailscale. | faible | signal faible | [radar](../2026-08-28/radar-architecture.md#tailcat) |
| 27 | [Orca](https://github.com/stablyai/orca) | Explore l’exécution parallèle d’une flotte d’agents. | faible | signal faible | [radar](../2026-08-28/radar-architecture.md#orca) |
| 28 | [MCP Apps](https://modelcontextprotocol.io/specification/2026-07-28) | Étend MCP vers des interfaces utilisateur servies par les capacités du serveur. | émergente | veille | [carte MCP](../2026-08-29/carte-mcp.md) |
| 29 | [OpenTelemetry entity events](https://opentelemetry.io/blog/2026/consuming-opentelemetry-entity-events/) | Relie inventaire temporel et signaux d’observabilité pour mieux suivre les entités. | émergente | veille | [radar](../2026-08-29/radar-architecture.md#opentelemetry-entity-events) |
| 30 | [HashiCorp Support Cycle 2](https://www.hashicorp.com/en/long-term-support) | Change le contrat de support des versions HashiCorp récentes. | stable | veille | [radar](../2026-08-29/radar-architecture.md#hashicorp-support-cycle-2) |
| 31 | [Elastic Cloud Serverless](https://www.elastic.co/docs/release-notes/cloud-serverless/deprecations) | Signale une migration nécessaire des API internes de Stack Monitoring. | stable | veille | [radar](../2026-08-30/radar-architecture.md#elastic-cloud-serverless-dépréciation-du-monitoring-interne) |
| 32 | [Inférence cloud-native](https://www.cncf.io/blog/2026/03/24/welcome-llm-d-to-the-cncf-evolving-kubernetes-into-sota-ai-infrastructure/) | Assemble GPU, cache, scheduling et serving comme une plateforme d’inférence. | forte | à qualifier | [radar](../2026-08-27/radar-architecture.md#inférence-cloud-native) |
